    ...
    <>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden" aria-labelledby="services-hero-heading">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-[#16508C]/75 via-[#16508C]/55 to-[#16508C]/75" />
          <div className="absolute inset-0 bg-gradient-to-t from-[#16508C]/65 via-[#16508C]/15 to-transparent" />
        </div>
