...
// Legacy hardcoded À-propos page. Rendered as a fallback by src/pages/AboutPage.jsx when no
// CMS `page.about` document exists yet. Once the page is seeded/edited via /admin, the CMS
// version takes over. Kept intact so the route is never at risk.
